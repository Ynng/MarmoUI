...
function runMarmoUI()
{
	...
	//Colors
	const red_tint = [255, 107, 107];
	const green_tint = [40, 150, 90];
	const yellow_tint = [217, 156, 58];
	...
	function applyTintIfEqual(elements, text)
	{
		...
		{
			elements.highlight(false, green_tint, tint_opacity);
			return;
		}
		...
		if(matches != null)
		{
          ...
          elements.highlight(false, yellow_tint, tint_opacity);
			}
			else
			{
				elements.highlight(false, red_tint, 0.25);
